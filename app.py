...
st.dataframe(near_due, use_container_width=True, hide_index=True)
...
if station:
    ...
    station_df = station_df[['Nội dung công việc','Thời gian còn lại (H)']].sort_values('Thời gian còn lại (H)')
